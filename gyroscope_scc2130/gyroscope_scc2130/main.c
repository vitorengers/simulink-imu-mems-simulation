...
void init_SSI0(void)
{
    ...
    SSIConfigSetExpClk(SSI0_BASE, SysCtlClockGet(), SSI_FRF_MOTO_MODE_0, SSI_MODE_MASTER, 5000000, 16); //TODO: Check SPI bitrate again...
    SSIEnable(SSI0_BASE);
...
uint32_t send_request_SCC_1(uint32_t request)
{
    ...
    GPIOPinWrite(GPIO_PORTA_BASE, GPIO_PIN_6, 0x00); // Chip select on
