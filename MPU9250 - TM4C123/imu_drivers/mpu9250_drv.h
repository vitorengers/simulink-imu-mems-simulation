...
#ifndef __IMU_BOARD_MPU9250_DRV_H__
#define __IMU_BOARD_MPU9250_DRV_H__
...
public:
    ...
    */
    static MPU9250Drv & instance(const uint8_t & t_unit);

    /*!

    */
    static const MPU9250Drv & i(const uint8_t & t_unit) {
...
private:
     ...
     */
    MPU9250Drv(const uint8_t & t_unit);
